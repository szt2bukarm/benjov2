...
var Heaven = React__default.createContext();
var clamp = function clamp(value) {
  return Math.max(Math.min(value, 1), 0);
};
var useHeaven = function useHeaven() {
  return React.useContext(Heaven);
};
var HeavenScroll = function HeavenScroll(_ref) {
  ...
  var SCROLL_ID = React.useRef(null);
  ...
  var smoothScrollingHandler = React.useCallback(function () {
  ...
  return disable ? children : /*#__PURE__*/React__default.createElement(Heaven.Provider, {
    value: heaven
...
exports.default = HeavenScroll;
exports.useHeaven = useHeaven;
